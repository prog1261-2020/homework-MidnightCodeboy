...
NoughtsAndCrosses::NoughtsAndCrosses(PlayerType player1, PlayerType player2) {
    ...
    if (player1 == PlayerType::HUMAN_PLAYER)
        ...
        players.push_back(new HumanPlayer('x')); // will be AIPlayer but not implemented yet

    // set up player 1
    if (player1 == PlayerType::HUMAN_PLAYER)
        players.push_back(new HumanPlayer('o'));
    else
        players.push_back(new HumanPlayer('o')); // will be AIPlayer but not implemented yet
}
